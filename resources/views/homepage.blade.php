                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-6">
                            <div class="fastest-delivery">
                                <h4>#AyamPalingHot</h4>
                                <h1 style="color: #231a2e;">Ayam Mama Muda</h1>

                                <p style="color: #6d6d6d;">Makanan enak mulai dari bahan yang berkualitas, Kami hanya
                                    memberikan kualitas terbaik</p>
                        ...
                        <div class="col-xl-6">
                            <div class="fastest-delivery-img">
                                <div class="good-food-steak-upto">
                                    <div>
                                        <h6>Lezatnya</h6>
                                        <h2 style="font-size: 35px;">Maknyus</h2>
    ...
    <section class="gap">
        <div class="container">
            <div class="welcome-to-foodio about-food">
                <span>Tentang Ayam Mama Muda</span>
                <h2>#AyamPalingHot yang kriuk,enak dan murah</h2>
            </div>
            <div class="row">
                <div class="col-lg-7">
                    <div class="featured-arae-two-img three d-flex">
                        <img alt="featured-arae-two-img" class="me-4" src="{{ asset('img/mamamuda2.png') }}">
                        <img alt="featured-arae-two-img" src="{{ asset('img/mamamuda3.png') }}">
                    </div>
                </div>
                <div class="col-xl-5">
                    <div class="about-food-text">
                        <p>Ayam mama muda adalah restoran ayam dengan berbagai macam rasa dan bumbu dengan gabungan
                            konsep content creation</p>
                        <div class="mt-5 d-flex align-items-center">
                            <div><i>
                                    <svg version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                         viewBox="0 0 489.672 489.672"
                                         style="enable-background:new 0 0 489.672 489.672;" xml:space="preserve">
       <path d="M242.38,44.104c-1.56-1.512-3.704-2.32-5.856-2.224c-14.04,0.552-28.04,2.52-41.6,5.864l3.832,15.536
          ...
          C132.06,345.672,119.756,354.328,113.5,369.088z"/>
                            ...
                            <div>
                                ...
                                <p>Makanan kami dapat diorder melalui mitra pengiriman online seperti grabfood dan
                                    gofood</p>
                            </div>
                        </div>
                            ...
                            <div>
                                <i>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="512"
                                         height="512">
                                        <g id="Delivery_Food_Order" data-name="Delivery Food Order">
                                            <path d="M38,33V5a5,5,0,0,0-5-5H15a5,5,0,0,0-5,5V41a5,5,0,0,0,5,5h6.29l2.06,1.76a1,1,0,1,0,1.3-1.52l-6-5.16a.9.9,0,0,1,.88-1.53L23.68,41a1,1,0,0,0,.9-.14A1,1,0,0,0,25,40V27a1,1,0,0,1,2,0V38a1,1,0,0,0,2,0V34a1,1,0,0,1,2,0v4a1,1,0,0,0,2,0V35a1,1,0,0,1,2,0v3a1,1,0,0,0,2,0V36a1,1,0,0,1,2,0V47a1,1,0,0,0,2,0V36A3,3,0,0,0,38,33ZM29,2V3a1,1,0,0,1-1,1H20a1,1,0,0,1-1-1V2ZM26,24a3,3,0,0,0-2.82,2H17V25a7,7,0,1,1,14,0v1H28.82A3,3,0,0,0,26,24Zm8,8a2.94,2.94,0,0,0-1.47.4A3,3,0,0,0,29,31.18V28h4a1,1,0,0,0,0-2V25a9,9,0,0,0-8-8.94V15a1,1,0,0,0-2,0v1.06A9,9,0,0,0,15,25v1a1,1,0,0,0,0,2h8V38.61l-2.88-1a2.9,2.9,0,0,0-2.82,4.94L19,44H15a3,3,0,0,1-3-3V5a3,3,0,0,1,3-3h2V3a3,3,0,0,0,3,3h8a3,3,0,0,0,3-3V2h2a3,3,0,0,1,3,3V32.78A3,3,0,0,0,34,32Z"/>
                                        </g>
                                    </svg>
                                </i></div>
                            <div>
                                <a href="#"><h5>100% Bahan Berkualitas</h5></a>
                                <p>kami berkomitmen untuk selalu menggunakan bahan - bahan yang berkualitas dan
                                    fresh</p>
                            </div>
                        </div>
                    </div>
    ...
    <section class="how-we-work">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-7">
                    <div class="heading">
                        <h6 style="color: #231a2e;">PESAN DENGAN 3 LANGKAH</h6>
                        <h2 style="color: #231a2e;">How We Work</h2>
                    </div>
                    <div style="color: #231a2e;" class="easy-orded-style">
                        <div style="color: #231a2e;" class="easy-orded">
                            <sup>1</sup>
                            <i>
                                <svg enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512"
                                    ...
                                    <path d="m161.817 339.005c-8.284 0-15 6.716-15 15s6.716 15 15 15h72c8.284 0 15-6.716 15-15s-6.716-15-15-15z"/>
                                    <path d="m352.25 399.005h-192.5c-8.284 0-15 6.716-15 15s6.716 15 15 15h192.5c8.284 0 15-6.716 15-15s-6.716-15-15-15z"/>
                                </svg>
                            </i>
                            <h4 style="color: #231a2e;">Explore Menu</h4>
                            <p style="color: #231a2e;">Eksplor dan pilih sesuai selera anda dari banyak menu yang kami
                                sediakan</p>
                        </div>
                     ...
                     <g>
                         ...
                         <line style="fill:none;stroke:#000000;stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;"
                               x1="15" y1="437" x2="497" y2="437"/>
                         <path style="fill:none;stroke:#000000;stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;"
                               d="&#10;&#9;&#9;M465.4,436c-3.43-112.69-95.87-203-209.4-203S50.03,323.31,46.6,436"/>

                         <line style="fill:none;stroke:#000000;stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;"
                               x1="256" y1="197" x2="256" y2="230"/>
                         <path style="fill:none;stroke:#000000;stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;"
                         ...
                         <path style="fill:none;stroke:#000000;stroke-width:30;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;"
                            ...
                            <p style="color: #231a2e;">Setelah menentukan selera anda bisa memilih jumlah menu yang
                                diorder</p>
                        </div>
                        <div class="easy-orded">
                            <sup>3</sup>
                            ...
                            <p style="color: #231a2e;">Lakukan pesanan baik via offline/Whatsapp ataupun
                                Grabfood/Gofood</p>
                        </div>
                    </div>
                </div>
